中文开源字体集 Open Fonts Collection for Chinese
======
...
如果你是中文开源字体项目的开发者、参与者，或者关注和使用中文开源字体，对本项目有任何建设性意见，或发现集合中存在错误内容，或发现了中文开源字体，可提交issues或Pull requests，也可在[网站](https://drfun.xyz/typeface/osfcc)下方评论，或加入[Telegram群组](https://t.me/fatetypo)参与讨论。
